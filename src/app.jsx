		...
		return (<div>
			...
			<Segment style={{margin: '1em'}} padded>
				<Header as='h2'>
					...
					<Header.Content>
						W3DNS
						<Header.Subheader>Inspect domain names</Header.Subheader>
					</Header.Content>
				</Header>
  				<div style={{paddingBottom: '1em'}}>
					<div style={{fontSize: 'small'}}>domain</div>
					<AccountIdBond bond={this.domain}/>
					<If condition={this.domain.ready()} then={
						<Label>Owner
							<Label.Detail>
								<Pretty value={runtime.w3ns.dns(this.domain)}/>
							</Label.Detail>
						</Label>
					}/>
				</div>
